...
func main() {
	...
	// Can also set to :13 for the first 13 characters; or 10: for characters from 10 to the end
	fmt.Println(name[10:13])	// Characters from position 10 through position 13
